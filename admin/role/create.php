                          ...
                          if ($get_permission) {
                            while ($row = $get_permission->fetch_assoc()) {
                              ...
                              <div class="col-md-4">
                                <div class="checkbox">
                                  <label>
                                    <input type="checkbox" class="collect_software_due" value="<?php echo $row['serial_no'] ?>" id="checkbox_<?php echo $row['serial_no'] ?>" name="permission[]"> <?php echo ucwords($final_name); ?>
                                  </label>
                                </div>
                              </div>
                          ...
                          if ($get_permission) {
                            while ($row = $get_permission->fetch_assoc()) {
                              ...
                              <div class="col-md-4">
                                <div class="checkbox">
                                  <label>
                                    <input type="checkbox" class="office_account" value="<?php echo $row['serial_no'] ?>" id="checkbox_<?php echo $row['serial_no'] ?>" name="permission[]"> <?php echo ucwords($final_name); ?>
                                  </label>
                                </div>
                              </div>
...
<!-- Account section -->
                  <div class="row">
                      <div class="col-md-2">
                        <div class="checkbox">
                          <label class="text-uppercase">
                            <input type="checkbox" id="office_stuff"> <b style="margin-top: 0px; font-sixe:18px;color: red">Office Stuff :</b>
                          </label>
                        </div>
                      </div>
                      <div class="col-md-10">
                          ...
                          if ($get_permission) {
                            while ($row = $get_permission->fetch_assoc()) {
                              ...
                              <div class="col-md-4">
                                <div class="checkbox">
                                  <label>
                                    <input type="checkbox" class="office_stuff" value="<?php echo $row['serial_no'] ?>" id="checkbox_<?php echo $row['serial_no'] ?>" name="permission[]"> <?php echo ucwords($final_name); ?>
                                  </label>
                                </div>
                              </div>
