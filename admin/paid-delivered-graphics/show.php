...
ajax();
Session::checkSession('admin', ADMIN_URL.'/paid-delivered-graphics', 'Unpaid Graphics Order');
if (isset($_GET['delivered_graphics_order_id'])) {
    $price = '';
    $delivered_graphics_order_id = $_GET['delivered_graphics_order_id'];
    $query = "SELECT * FROM graphics_info WHERE id='$delivered_graphics_order_id'";
    ...
    if ($result) {
        ...
        if ($delivered_graphics_order_id) {
          $query_graphics_pay = "select * from graphics_pay WHERE order_id = '$delivered_graphics_order_id' ";
...
<?php 
        ...
        if ($delivered_graphics_order_id) {
          $query_graphics_pay = "SELECT * FROM graphics_pay WHERE order_id = '$delivered_graphics_order_id' order by id desc ";
          $result_graphics_pay = $db->select($query_graphics_pay);
