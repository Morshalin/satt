...
<!-- Login form -->
  <fieldset class="mb-3">
    <div class="row">
        ...
        <div class="col-lg-8">
    <legend class="text-uppercase font-size-m font-weight-bold">Software Basic Informantion </legend>
            <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="row">
                    ...
                    <h6 class="col-md-8"><?php echo $row_price['installation_charge']; ?> /=</h6>
            </div>
            <div class="row">
                    <b class="col-md-4">Monthly Cahrge :</b>
                    <h6 class="col-md-8"><?php echo $row_price['monthly_charge']; ?> /=</h6>
            </div>
            <div class="row">
                    <b class="col-md-4">Yearly Charge :</b>
                    <h6 class="col-md-8"><?php echo $row_price['yearly_charge']; ?> /=</h6>
            </div>
            <div class="row">
                    <b class="col-md-4">Direct Sell(One Time) :</b>
                    <h6 class="col-md-8"><?php echo $row_price['direct_sell']; ?> /=</h6>
            </div>
            <div class="row">
                    <b class="col-md-4">Total Price :</b>
                    <h6 class="col-md-8"><?php echo $row_price['total_price']; ?> /=</h6>
            </div>
            <div class="row">
                    <b class="col-md-4">Agent Commission (One Time Sell) :</b>
                    <h6 class="col-md-8"><?php echo $row_price['agent_commission_one_time']; ?> /=</h6>
            </div>
            <div class="row">
                    <b class="col-md-4">Agent Commission (Monthly) :</b>
                    <h6 class="col-md-8"><?php echo $row_price['agent_commission_monthly']; ?> /=</h6>
            </div>
            <div class="row">
                    <b class="col-md-4">Maximum Discount Offer  :</b>
                    <h6 class="col-md-8"><?php echo $row_price['discount_offer']; ?> /=</h6>
            </div>
             <div class="row">
                    <b class="col-md-4">Yearly Renew Charge  :</b>
                    <h6 class="col-md-8"><?php echo $row_price['yearly_renew_charge']; ?> /=</h6>
            </div>
