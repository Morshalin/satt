...
<!-- Login form -->
<form class="form-validate-jquery" action="<?php echo ADMIN_URL; ?>/customerdetails/ajax.php?customerdetails_id=<?php echo $customerdetails_id; ?>&action=update" id="content_form" method="post">
  <fieldset class="mb-3">
            ...
            <div class="form-group">
              ...
              <select multiple="multiple" class="form-control select" id="interested_services" name="interested_services[]">
                <?php 
                    ...
                    $query_ins= "SELECT * FROM satt_interested_services WHERE cutomer_details_id = '$customerdetails_id'";
