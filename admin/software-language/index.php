...
<div class="content">
  <div class="card border-top-success rounded-top-0" id="table_card">
  	<div class="card-header header-elements-inline bg-light border-grey-300" >
  		...
  		<button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round" id="content_managment" data-url="<?php echo ADMIN_URL; ?>/software-language/create.php"><i class="icon-stack-plus mr-1"></i>Add Software Language</button>
  		</h5>
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo ADMIN_URL; ?>/software-language/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
  						<th>Software Language Name</th>
  						<th>Status</th>
  						<th>Action</th>
  					</tr>
  				</thead>
