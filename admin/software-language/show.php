...
<!-- Login form -->
  <fieldset class="mb-3">
    <legend class="text-uppercase font-size-sm font-weight-bold">View Software Language </legend>
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label for="course_name" class="col-form-label">Software Language Name <span class="text-danger">*</span></label>
                <input type="text" name="software_language_name" id="software_language_name" class="form-control" placeholder="New Software Status Name" readonly autofocus value="<?php echo $row['software_language_name'] ?>">
