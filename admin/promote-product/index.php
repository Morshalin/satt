...
Session::checkSession('admin', ADMIN_URL . '/promote-product', 'Promote Products');
  $data = array();
  $data['page_title'] = 'Promote Products';
  $data['element'] = ['modal' => 'lg'];
  $data['page_index'] = 'promote-product';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/admin/promote-product'];
?>
...
<div class="content">
  <div class="card border-top-success rounded-top-0" id="table_card">
  	<div class="card-header header-elements-inline bg-light border-grey-300" >
  		...
  		<button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round" id="content_managment" data-url="<?php echo ADMIN_URL; ?>/promote-product/create.php"><i class="icon-stack-plus mr-1"></i>Add Promote Products</button>
  		</h5>
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo ADMIN_URL; ?>/promote-product/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
              <th>Product Name</th>
