    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="text" name="first_name" id="first_name" class="form-control" placeholder="Type Your first name" required autofocus value="<?php echo $row['first_name']; ?>">
                <input type="hidden" name="admin_user_id" value="<?php echo $row['user_id']; ?>">
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
