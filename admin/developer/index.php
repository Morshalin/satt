...
Session::checkSession('admin', ADMIN_URL . '/developer', 'Developer');
  ...
  $data['page_index'] = 'developer';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/admin/developer'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo ADMIN_URL; ?>/developer/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
  						<th>Name</th>
