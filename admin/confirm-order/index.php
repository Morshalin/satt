<?php
  ...
  $data['page_index'] = 'confirm-order';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/admin/confirm-order'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo ADMIN_URL; ?>/confirm-order/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
              <th>Product Name</th>
