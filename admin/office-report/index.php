...
Session::checkSession('admin', ADMIN_URL . '/office-report', 'Office Report');
$data = array();
$data['page_title'] = 'Office Report';
$data['element'] = ['modal' => 'lg'];
$data['page_index'] = 'office-report';
$data['page_css'] = [];
$data['page_js'] = ['assets/js/admin/office-report'];
$customer_id =  $user['id'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label for="invoice_type" class="col-form-label">Report Type<span class="text-danger">*</span></label>
