<?php
  ...
  $data = array();
  $data['page_title'] = 'Unpaid Graphics Order';
  $data['element'] = ['modal' => 'lg'];
  $data['page_index'] = 'unpaid-delivered-graphics';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/admin/unpaid-delivered-graphics'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo ADMIN_URL; ?>/unpaid-delivered-graphics/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
              <th>Customer Name</th>
