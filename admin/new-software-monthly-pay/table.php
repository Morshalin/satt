        ...
        <div class="list-icons" id="action_menu_' . $row['id'] . '">
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
             ...
             <span class="dropdown-item" id="content_managment" data-url="' . ADMIN_URL .'/new-software-monthly-pay/confirm_order.php?new_order_id='.$row['id'].'" style = "color:green"><i class="icon-checkmark4"></i> Confirm Order</span>


             <span class="dropdown-item" id="content_managment" data-url="' . ADMIN_URL .'/new-software-monthly-pay/cancel_order.php?new_order_id='.$row['id'].'" style = "color:red"><i class="icon-cancel-square"></i> Cancel Order</span>
            </div>
          </div>
        </div>
        ',
