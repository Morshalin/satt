...
Session::checkSession('admin', ADMIN_URL . '/office_stuff', 'Office Stuff');
  $data = array();
  $data['page_title'] = 'Office Stuff';
  $data['element'] = ['modal' => 'lg'];
  $data['page_index'] = 'office_stuff';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/admin/office_stuff'];
?>
...
<div class="content">
  <div class="card border-top-success rounded-top-0" id="table_card">
  	<div class="card-header header-elements-inline bg-light border-grey-300" >
  		...
  		<button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round" id="content_managment" data-url="<?php echo ADMIN_URL; ?>/office_stuff/create.php"><i class="icon-stack-plus mr-1"></i>Add Office Stuff</button>
  		</h5>
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo ADMIN_URL; ?>/office_stuff/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
  						<th>Name</th>
