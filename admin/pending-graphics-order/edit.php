...
<!-- Login form -->
<form class="form-validate-jquery" action="<?php echo ADMIN_URL; ?>/pending-graphics-order/ajax.php?pending_graphics_order_id=<?php echo $pending_graphics_order_id; ?>&action=update" id="content_form" method="post">
  <fieldset class="mb-3">
