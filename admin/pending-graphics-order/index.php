<?php
  ...
  $data = array();
  $data['page_title'] = 'Pending Graphics Order';
  $data['element'] = ['modal' => 'lg'];
  $data['page_index'] = 'pending-graphics-order';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/admin/pending-graphics-order'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo ADMIN_URL; ?>/pending-graphics-order/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
              <th>Customer Name</th>
