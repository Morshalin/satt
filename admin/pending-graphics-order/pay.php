...
if ($pending_graphics_order_id) {
    ...
    $pay_query = "SELECT * FROM graphics_pay WHERE order_id ='$pending_graphics_order_id'";
...
<!-- Login form -->
<form class="form-validate-jquery" action="<?php echo ADMIN_URL; ?>/pending-graphics-order/ajax_pay.php?pay_order_id=<?php echo $pending_graphics_order_id; ?>" id="content_form" method="post">
  <fieldset class="mb-3">
