...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$query = "SELECT * FROM admin_customer_chat WHERE to_user_id = '$admin_id' to_whom = 'admin' AND seen_status_admin = '0'";
	...
	$query = "SELECT * FROM agent_admin_chat WHERE to_user_id = '$admin_id' to_whom = 'admin' AND seen_status_admin = '0'";
