...
ajax();
Session::checkSession('admin', ADMIN_URL . '/existing-software-onetime-sell-pay', 'Existing software onetime sell pay');
if (isset($_GET['new_order_id'])) {
    ...
    if ($result) {
        ...
        die(json_encode(['message' => 'Existing software onetime sell pay Not Found']));
    }
    ...
    if ($new_order_id) {
        ...
        if ($pay_result) { ?>
                <div class="table-responsive">
                    <h4 class="text-danger">Onetime Sell Pay</h4>
