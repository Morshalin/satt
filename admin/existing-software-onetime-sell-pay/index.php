<?php
  ...
  Session::checkSession('admin', ADMIN_URL . '/existing-software-onetime-sell-pay','Existing Software one-time-sell Pay');
  $data = array();
  $data['page_title'] = 'Existing Software One Time Sell Pay';
  $data['element'] = ['modal' => 'lg'];
  $data['page_index'] = 'existing-software-onetime-sell-pay';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/admin/existing-software-onetime-sell-pay'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo ADMIN_URL; ?>/existing-software-onetime-sell-pay/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
						<th>Software Name</th>
