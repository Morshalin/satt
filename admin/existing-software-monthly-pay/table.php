        ...
        <div class="list-icons" id="action_menu_' . $row['id'] . '">
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <span class="dropdown-item" id="content_managment" data-url="' . ADMIN_URL . '/existing-software-monthly-pay/show.php?pending_order_id=' . $row['id'] . '"><i class="icon-eye"></i> View</span>
              <span class="dropdown-item text-danger" id="content_managment" data-url="' . ADMIN_URL . '/existing-software-monthly-pay/cancel-order.php?pending_order_id=' . $row['id'] . '"><i class="icon-cancel-circle2"></i> Cancel Order</span>
              <span class="dropdown-item text-success" id="content_managment" data-url="' . ADMIN_URL . '/existing-software-monthly-pay/confirm-order.php?pending_order_id=' . $row['id'] . '"><i class="icon-checkmark4"></i> Confirm Order</span>
            </div>
          </div>
        </div>
        ',
