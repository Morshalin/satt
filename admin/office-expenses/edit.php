...
<!-- Login form -->
<form class="form-validate-jquery" action="<?php echo ADMIN_URL; ?>/office-expenses/ajax.php?office_expense_id=<?php echo $office_expense_id; ?>&action=update" id="content_form" method="post">
      <fieldset class="mb-3">
