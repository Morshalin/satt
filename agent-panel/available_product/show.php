    ...
    <div class="col-sm-8">
        ...
        if ($software_id) {
            ...
            if ($new_result_price) {
             ...
             <div class="row">
                <div class="col-md-12">
                    <legend class="text-uppercase text-center font-size-m font-weight-bold">Agent Comission </legend>
                </div>
                </div>
                <div class="col-lg-6">
                    <div class="row" >
                ...
                <div class="row" >
                    <b class="col-md-8">New Agent Commission (Yearly) :</b>
                    <h6 class="col-md-4"><?php echo $new_row_price['agent_commission_yearly']; ?> /=</h6>
                </div>
                </div>
