...
$data['page_css'] = [];
$data['page_js'] = ['assets/js/agent-panel/order-new-software'];
$agent_id =  $user['id'];
?>
...
<div class="content">
  <div class="card border-top-success rounded-top-0" id="table_card">
      ...
      <form class="form-validate-jquery" action="<?php echo AGENT_URL; ?>/order-new-software/ajax.php" id="content_form" method="post" enctype="multipart/form-data">
        <fieldset class="mb-3">
          ...
          <section class="fromarea">
            <div class="container py-5 bg-white" style="width: 100%; padding-right: 5%; padding-left: 5%; margin-top: -20px">
              ...
              <div class="row">
                ...
                <div class="col-lg-8" style=" margin-top: 40px;">
                  <div class="form-group">
                    <label for="name" class="col-form-label"><span>Select Your Client
                    </span> </label>
                    <select name="customer_id" id="customer_id" class="form-control select" >
                      ...
                      if ($get_client) {
                        while ($row= $get_client->fetch_assoc()) {
                          ?>
                          <option value="<?php echo $row['client_id'] ?>">Name : <?php echo $row['client_name']; ?></option>
                          <?php
                        }
                      }
