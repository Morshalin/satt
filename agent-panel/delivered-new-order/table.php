...
ajax();
Session::checkSession('agent-panel', AGENT_URL . '/delivered-new-order');
## Read value
$draw = $_GET['draw'];
$row = $_GET['start'];
...
=================================================================================*/
$agent_id = $user['id'];
$query = "select * from new_product_order WHERE  confirmation_status = '1' AND delivery_status = '1' AND cancel_status = '0' and agent_id = '$agent_id'" . $searchQuery . " order by " . $columnName . " " . $columnSortOrder . " limit " . $row . "," . $rowperpage;
        ...
        <div class="list-icons" id="action_menu_' . $row['id'] . '">
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <span class="dropdown-item" id="content_managment" data-url="' . AGENT_URL .'/delivered-new-order/show.php?new_order_id=' . $row['id'] . '"><i class="icon-eye"></i> View</span>
