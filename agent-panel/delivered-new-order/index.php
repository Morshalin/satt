<?php
  ...
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/agent-panel/delivered-new-order'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
    ...
    <div class="card-body">
      ...
      <div id="table_display">
        <table class="table content_managment_table" data-url="<?php echo AGENT_URL; ?>/delivered-new-order/table.php">
          <thead>
            <tr>
              <th>#</th>
              <th>Software Name</th>
