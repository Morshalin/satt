...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($error) {
		...
		if ($last_id) {
			...
			// 
			$agent_sql = "INSERT INTO agent_client(agent_id,client_id,client_name,add_date) VALUES('$agentId','$last_id','$name',now())";
					$agent_insert = $db->insert($agent_sql);


		if ($agent_insert != false) {
