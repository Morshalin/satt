...
<head>
	...
	<link href="<?php echo AGENT_URL; ?>/jquery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css">
  ...
  ?>
	...
	<script>
		...
		const AGENT_URL = '<?php echo BASE_URL; ?>/agent-panel';
...
<body>
<?php if (Session::get('agent-panel')) {
	?>
	<!-- Main navbar -->
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link dropdown-toggle" data-toggle="dropdown">
						...
						<span><?php echo gv($user, 'name') ?></span>
					</a>

					<div class="dropdown-menu dropdown-menu-right">
						<a href="<?php echo AGENT_URL; ?>/profile" class="dropdown-item"><i class="icon-user-plus"></i> My profile</a>
			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							<div class="mr-3">
								<a href="<?php echo ADMIN_URL; ?>/profile"><img src="<?php echo getUserImage($user); ?>" width="38" height="38" class="rounded-circle" alt="<?php echo gv($user, 'name'); ?>"></a>
							</div>
...
<input type="hidden" name="agent_id" id="agent_id" value="<?php echo($user['id']); ?>">
		<!-- Main content -->
