...
ajax();
Session::checkSession('customer-panel', CUSTOMER_URL . '/available_product', 'Software Details');
...
<!-- Login form -->
<form class="form-validate-jquery" action="<?php echo CUSTOMER_URL; ?>/available_product/ajax-selling.php?software_details_id=<?php echo $software_details_id; ?>&action=update" id="content_form" method="post">
  <fieldset class="mb-3">
