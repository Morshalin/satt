...
ajax();
Session::checkSession('customer-panel', CUSTOMER_URL . '/pending-new-software');
## Read value
$draw = $_GET['draw'];
$row = $_GET['start'];
...
=================================================================================*/
$customer_id = $user['id'];
$query = "select * from new_product_order WHERE  confirmation_status = '0' AND delivery_status = '0' AND cancel_status = '0' AND customer_id='$customer_id' " . $searchQuery . " order by " . $columnName . " " . $columnSortOrder . " limit " . $row . "," . $rowperpage;
        ...
        <div class="list-icons" id="action_menu_' . $row['id'] . '">
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <span class="dropdown-item" id="content_managment" data-url="' . CUSTOMER_URL . '/pending-new-software/show.php?new_order_id=' . $row['id'] . '"><i class="icon-eye"></i> View</span>


             <span class="dropdown-item" id="content_managment" data-url="' . CUSTOMER_URL .'/pending-new-software/cancel_order.php?new_order_id='.$row['id'].'" style = "color:red"><i class="icon-cross"></i> Cancel Order</span>
            </div>
          </div>
        </div>
        ',
