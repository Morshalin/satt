<?php
  ...
  Session::checkSession('customer-panel', CUSTOMER_URL . '/pending-new-software','Pending Product');
  $data = array();
  $data['page_title'] = 'Pending Product';
  $data['element'] = ['modal' => 'lg'];
  $data['page_index'] = 'pending-new-software';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/customer-panel/pending-new-software'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo CUSTOMER_URL; ?>/pending-new-software/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
              <th>Software Name</th>
