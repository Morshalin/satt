<?php
  ...
  $data['page_index'] = 'pending_product';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/customer-panel/pending_product'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo CUSTOMER_URL; ?>/pending_product/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
              <th>Product Name</th>
