...
ajax();
Session::checkSession('customer-panel', CUSTOMER_URL . '/pending_product');
## Read value
$draw = $_GET['draw'];
$row = $_GET['start'];
        ...
        <div class="list-icons" id="action_menu_' . $row['id'] . '">
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <span class="dropdown-item" id="content_managment" data-url="' . CUSTOMER_URL . '/pending_product/show.php?order_id=' . $row['id'] . '"><i class="icon-eye"></i> View</span>


             <span class="dropdown-item" id="content_managment" data-url="' . CUSTOMER_URL . '/pending_product/reasion.php?order_id=' . $row['id'] . '"><i class="icon-cross"></i> Cancel Product</span>
            </div>
          </div>
        </div>
        ',
