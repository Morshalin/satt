<?php
  ...
  Session::checkSession('customer-panel', CUSTOMER_URL.'/message-with-agent', 'message-with-agent');
  $data = array();
  $data['page_title'] = 'Agent List';
  $data['element'] = ['modal' => 'lg'];
  $data['page_index'] = 'message-with-agent';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/customer-panel/message-with-agent'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo CUSTOMER_URL; ?>/message-with-agent/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
  						<th>Agent Name</th>
