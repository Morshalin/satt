<?php
  ...
  Session::checkSession('customer-panel', CUSTOMER_URL . '/delivered-new-order','Delivered New Order');
  $data = array();
  $data['page_title'] = 'Delivered New Order';
  $data['element'] = ['modal' => 'lg'];
  $data['page_index'] = 'delivered-new-order';
  $data['page_css'] = [];
  $data['page_js'] = ['assets/js/customer-panel/delivered-new-order'];
?>
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
    ...
    <div class="card-body">
      ...
      <div id="table_display">
        <table class="table content_managment_table" data-url="<?php echo CUSTOMER_URL; ?>/delivered-new-order/table.php">
          <thead>
            <tr>
              <th>#</th>
              <th>Software Name</th>
