<?php
  ...
  Session::checkSession('customer-panel', CUSTOMER_URL.'/delivered-order', 'Delivered Order');
  $data = array();
  ...
  <div class="card border-top-success rounded-top-0" id="table_card">
  	...
  	<div class="card-body">
  		...
  		<div id="table_display">
  			<table class="table content_managment_table" data-url="<?php echo CUSTOMER_URL; ?>/delivered-order/table.php">
  				<thead>
  					<tr>
  						<th>#</th>
              <th>Product Name</th>
